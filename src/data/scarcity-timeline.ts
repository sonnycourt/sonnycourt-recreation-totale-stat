...
export const WEEKLY_TIMELINE: Purchase[] = [
  { name: 'Thomas', flag: '🇫🇷', offsetMs: toOffset('Jeudi', '21:09:47') },
  { name: 'Sophie', flag: '🇧🇪', offsetMs: toOffset('Jeudi', '21:13:22') },
  { name: 'Nicolas', flag: '🇨🇭', offsetMs: toOffset('Jeudi', '21:18:05') },
  { name: 'Lea', flag: '🇫🇷', offsetMs: toOffset('Jeudi', '21:24:41') },
  { name: 'Jean-Philippe', flag: '🇨🇦', offsetMs: toOffset('Jeudi', '21:33:18') },
  { name: 'Maxime', flag: '🇫🇷', offsetMs: toOffset('Jeudi', '21:47:52') },
  { name: 'Charlotte', flag: '🇧🇪', offsetMs: toOffset('Jeudi', '22:06:34') },
  { name: 'Vanessa', flag: '🇨🇭', offsetMs: toOffset('Jeudi', '22:28:11') },
  { name: 'Julien', flag: '🇫🇷', offsetMs: toOffset('Jeudi', '22:51:47') },
  { name: 'Gabrielle', flag: '🇨🇦', offsetMs: toOffset('Jeudi', '23:17:29') },
  { name: 'Vincent', flag: '🇱🇺', offsetMs: toOffset('Vendredi', '00:42:15') },
