...
assert.equal(mc2ReplayRecoveryConfig({}).replayCtaSeconds, (74 * 60) + 50);
assert.equal(
...
}).replayUrl, 'https://vz-601d6eb4-a9a.b-cdn.net/e538dedd-26e0-4b69-9900-13a7ec8a37f8/playlist.m3u8');
assert.equal(mc2ReplayRecoveryConfig({
