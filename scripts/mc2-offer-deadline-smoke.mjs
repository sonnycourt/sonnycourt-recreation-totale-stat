...
assert.equal(MC2_REPLAY_OFFER_DURATION_MS, (72 * 60 * 60 - 79 * 60) * 1000);
...
assert.equal(activatedAt.toISOString(), '2026-08-13T19:24:00.000Z');
...
assert.equal(replayDeadline.toISOString(), '2026-08-18T10:41:00.000Z');
