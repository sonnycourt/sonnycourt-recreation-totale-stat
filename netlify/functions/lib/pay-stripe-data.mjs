...
export const PAY_STRIPE_RESOURCES = Object.freeze({
  ...
  payment_links: { path: 'payment_links', object: 'payment_link', label: 'Liens de paiement' },
  checkout_sessions: { path: 'checkout/sessions', object: 'checkout.session', created: true, label: 'Sessions Checkout' },
  ...
  subscriptions: { path: 'subscriptions', object: 'subscription', created: true, defaults: { status: 'all' }, label: 'Abonnements' },
