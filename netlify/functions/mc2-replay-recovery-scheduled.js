  ...
  for (let day = 0; day < 7; day += 1) {
    ...
    dailyLoads.push(supabaseGet(
      `mc2_registrations?session_starts_at=lte.${encodeURIComponent(upper.toISOString())}`
        ...
        + '&select=token,email,prenom,visitor_timezone,session_starts_at,session_ends_at,offer_expires_at,attended_live,saw_offer,watch_max_seconds_live,last_presence_at,statut,payment_status,purchased_at,entry_payment_required,entry_payment_paid_at'
