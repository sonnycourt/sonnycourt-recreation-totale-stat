...
function buildOverview(raw, now = new Date()) {
  ...
  const agents = [
    ...
    },
    {
      ...
      task: `Archive le scan de ${sentCampaigns.length} campagnes et ${automations.length} automations`, progress: 76,
    },
    {
    ...
    {
      id: 'iris', initials: 'IR', name: 'Iris', role: 'Chercheuse Voix du Client', division: 'Éditorial',
      color: 'cyan', spriteGroup: 'editorial', spriteIndex: 2,
      state: 'working', stateLabel: 'Signaux clients en lecture',
      task: `Cartographie les thèmes de ${sentCampaigns.length} campagnes récentes`, progress: 67,
    },
    {
